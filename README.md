# IT 140 Module {{ModNum}} Activity {{ActNum}}: {{ActivityTitle}}
...
Submit the following file(s) as one submission to the assignment drop box in D2L Brightspace for this activity before the due date:

- TODO: Replace with specific file(s) that need to be submitted for this activity

## Requirements

- TODO: Replace with any specific requirements for this activity.
